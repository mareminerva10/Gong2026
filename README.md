...
4. (Optional) `data/statnuri_unsold_panel.parquet`, `data/statnuri_completed_unsold_panel.parquet`, `data/national_redevelopment_intensity.parquet`, `data/statnuri_landuse_panel.parquet` — Block 4 controls (pre-completion unsold, post-completion unsold, redev intensity, gu-level land-use context).
